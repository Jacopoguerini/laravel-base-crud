        ...
        <form action="{{ route('comics.update', $comic->id) }}" method="POST">
            ...
            <div class="mt-2">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="type" id="type" value="comic book" type="radio" {{ ($comic->type=="comic book")? "checked" : "" }} required>
                    <label class="form-check-label" for="type">Comic Book</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="type" id="type" value="graphic novel" type="radio" {{ ($comic->type=="graphic novel")? "checked" : "" }} required>
