        ...
        <form action="{{ route('comics.store') }}" method="POST">
            ...
            <div class="mt-2">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="type" id="type" value="comic book">
                    <label class="form-check-label" for="type">Comic Book</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="type" id="type" value="graphic novel">
            ...
            <div class="form-group mt-1">
                ...
                <input type="date" class="form-control" id="date" placeholder="Inserisci la data di pubblicazione" name="date">
            </div>
